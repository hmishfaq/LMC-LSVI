...
from components.langevin_dqn.optim import LangevinAdam


class LangevinDQN(BaseAgent):
  '''
  Implementation of Langevin DQN
  '''
  def __init__(self, cfg):
    ...
    # Set optimizer
    assert self.cfg['optimizer']['name'] == 'LangevinAdam', 'Only LangevinAdam is supported for Langevin DQN.'
    self.optimizer = LangevinAdam(self.net.parameters(), **self.cfg['optimizer']['kwargs'])
